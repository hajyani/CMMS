    ...
    public static class IdentityConfigurationExtensions
    {
        public static void AddCustomIdentity(this IServiceCollection services, IdentitySettings settings)
        {
            services.AddIdentity<User, Role>(identityOptions =>
             {
                 //Password Settings
                 identityOptions.Password.RequireDigit = settings.PasswordRequireDigit; // رقم الزامی باشد
                 identityOptions.Password.RequiredLength = settings.PasswordRequiredLength;
                 identityOptions.Password.RequireNonAlphanumeric = settings.PasswordRequireNonAlphanumic; //#@!
                 identityOptions.Password.RequireUppercase = settings.PasswordRequireUppercase; // شامل حروف بزرگ باشد
                 identityOptions.Password.RequireLowercase = settings.PasswordRequireLowercase; // شامل حروف کوچک باشد
            ...
            services.ConfigureApplicationCookie(options =>
            {
                ...
                options.Cookie.Name = "WareHouseCookie";
